...
public class Exam_06 {
	...
	class Exercise6_4 {
		...
		class Student {
			...
			float getAverage(){
				float average=(int)((float) getTotal()/3*10+0.5)/10f;
				return average;
			}
	...
	public static void main(String args[]) {
		...
		System.out.println(s.info());
		 ...
		 class Student {
			...
			String info(){
				String answer=name+","+ban+","+no+","+kor+","+eng+","+math+","+getTotal()+","+getAverage();
				return answer;
			}
	...
	---------------------------------------------------------------------------------------------------------------------------
	marine 의 공통요소인 공격력과 방어력이 모두 같아야 하므로 클래스 변수로 정의한다.
	...
	e. 생성자는 오버로딩 할 수 없다.
	--------------------------------------------------------------------------------------------------------------------------
	b.생성자는 인스턴스변수를 초기화 하기 위한 것이다., c(없어도 java파일이 컴파일 되면서 기본생성자가 추가),e오버로딩 가능
	__________________________________________________________________________________________________________________________
